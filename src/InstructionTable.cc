...
const InstructionTableItem InstructionTable::one_byte_opcode_instruction_map[256] = {
	...
	{"inc", false, 1, {"BX",0,0}, GROUP_NONE, &InstructionDecoder::decodeReg, &ExecutionUnit::execINC},
	{"inc", false, 1, {"SP",0,0}, GROUP_NONE, &InstructionDecoder::decodeReg, &ExecutionUnit::execINC},
	{"inc", false, 1, {"BP",0,0}, GROUP_NONE, &InstructionDecoder::decodeReg, &ExecutionUnit::execINC},
	{"inc", false, 1, {"SI",0,0}, GROUP_NONE, &InstructionDecoder::decodeReg, &ExecutionUnit::execINC},
	{"inc", false, 1, {"DI",0,0}, GROUP_NONE, &InstructionDecoder::decodeReg, &ExecutionUnit::execINC},
	{"dec", false, 1, {"AX",0,0}, GROUP_NONE, &InstructionDecoder::decodeReg, &ExecutionUnit::execDEC},
	{"dec", false, 1, {"CX",0,0}, GROUP_NONE, &InstructionDecoder::decodeReg, &ExecutionUnit::execDEC},
	{"dec", false, 1, {"DX",0,0}, GROUP_NONE, &InstructionDecoder::decodeReg, &ExecutionUnit::execDEC},
	{"dec", false, 1, {"BX",0,0}, GROUP_NONE, &InstructionDecoder::decodeReg, &ExecutionUnit::execDEC},
	{"dec", false, 1, {"SP",0,0}, GROUP_NONE, &InstructionDecoder::decodeReg, &ExecutionUnit::execDEC},
	{"dec", false, 1, {"BP",0,0}, GROUP_NONE, &InstructionDecoder::decodeReg, &ExecutionUnit::execDEC},
